            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-zinc-700/50">
                    ...
                    <tr class="hover:bg-zinc-700/30 transition-colors">
                        ...
                        <td class="px-4 py-3 text-center">
                            <form method="POST" action="{{ route('admin.libros.toggle', $book) }}" class="inline">
                                @csrf
                                @method('PATCH')
                                <button type="submit"
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center justify-end gap-2">
                                ...
                                @endif
                                <a href="{{ route('admin.libros.edit', $book) }}"
                                   class="p-1.5 text-zinc-500 hover:text-amber-400 transition-colors rounded">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                    </svg>
                                </a>
                                <form method="POST" action="{{ route('admin.libros.destroy', $book) }}"
